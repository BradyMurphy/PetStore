        ...
        for(int i = 0; i < custAmmt; i++){
            ...
            for(int j = 0; j < I.items.size(); j++){
                ...
                if(buyChance == 0){
                    if(item.name == "pet"){
                        ...
                        if(pet.health){
                            ...
                            if(noDeal == 0){
                                ...
                                out(c.name + " is adding $" + String.format("%.2f", pet.salePrice) + " to the register.\n", day);
                                j = I.items.size();
                    ...
                    else if((item.name == "toy") || (item.name == "leash")){
                        ...
                        if(noDeal == 0){
                            ...
                            out(c.name + " is adding $" + String.format("%.2f", item.salePrice) + " to the register.\n", day);
                            j = I.items.size();
                        ...
                        out("Customer " + cust + " is thinking about buying " + item.name +".\n", day);
                        noDeal = rand.nextInt(2);
                        if(noDeal == 0){
                            out(c.name + " says Customer " + cust + " will pay for the " + item.name +" at list price.\n", day);
                            item.salePrice = item.listPrice;
                            ...
                            out(c.name + " is adding $" + String.format("%.2f", item.salePrice) + " to the register.\n", day);
                            j = I.items.size();
                            out("Customer " + cust + " has left the store after buying " + item.name + ".\n", day);
                        }
                        else{
                            out(t.name + " offered Customer " + cust + " a 10% discount on the " + item.name + "\n", day);
                            deal = rand.nextInt(4);
